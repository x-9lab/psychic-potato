...
type Props = Record<string, any> & RouteProps;
...
class AppNavMenu extends PureComponent<Props, State> {
    ...
    onClick = e => {
        ...
        // let title = e.item.props["data-item"].title || "";
        // eventcenter.emit(LAYOUT_SET_TITLE, title);
    }
